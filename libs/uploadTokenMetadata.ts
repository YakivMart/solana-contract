...
export async function uploadTokenMetadata(
    ...
    try {
        ...
        // let buffer = fs.readFileSync("assets/monkey.png");
        // let file = toMetaplexFile(buffer, "monkey.png")
...
export async function createTokenMetadata(
    ...
    const buffer = fs.readFileSync("assets/monkey.png")

    // buffer to metaplex file
    const file = toMetaplexFile(buffer, "monkey.png")
